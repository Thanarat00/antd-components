...
const ModalDemo = ({ children, ...props }: Partial<React.ComponentProps<typeof CustomModal>> & { children?: React.ReactNode }) => {
...
export const WithConfirm: StoryObj = {
  render: () => (
    <ModalDemo
...
export const HideCancel: StoryObj = {
  render: () => (
    <ModalDemo
      title="ข้อมูลสำคัญ"
      hideCancel
...
export const ConfirmInfo: StoryObj = {
  render: () => {
    const [open, setOpen] = useState(false);
    return (
      <>
...
export const ConfirmSuccess: StoryObj = {
  render: () => {
    const [open, setOpen] = useState(false);
    return (
      <>
...
export const ConfirmError: StoryObj = {
  render: () => {
    const [open, setOpen] = useState(false);
    return (
      <>
    ...
    return (
      <>
        ...
        <ResultModal
          ...
          subtitle="เลขที่คำสั่งซื้อ: ORD-2024001234"
          open={open}
          onClose={() => setOpen(false)}
        />
      </>
