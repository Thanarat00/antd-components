...
const columnsWithActions = [
  ...
  createActionColumn<Product>([
    ...
    { key: 'delete', label: 'ลบ', icon: <DeleteOutlined />, danger: true, onClick: (record) => console.log('Delete', record) },
  ]),
];
...
export const WithoutCard: StoryObj = {
  render: () => (
...
export const CustomPagination: StoryObj = {
  render: () => (
    <div className="p-4">
      <CustomTable
        title="รายการสินค้า"
